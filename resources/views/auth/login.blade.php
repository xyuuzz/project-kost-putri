    ...
    <section class="section">
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            {{-- <img src="{{asset("storage/images/logo kost putri 2.png")}}" alt="logo" width="50" class="shadow-light rounded-circle mb-5 mt-2"> --}}
            <h4 class="text-dark font-weight-normal">Welcome to <span class="font-weight-bold">Website Kost Putri Pak Kaji</span></h4>
            <p class="text-muted">Silahkan Log In menggunakan akun yang sudah diberikan kepada Anda</p>
            @error('failed_login')
            ...
            <form method="POST" action="{{route("auth_login")}}" class="needs-validation" novalidate="">
              ...
              <div class="form-group">
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" name="remember" class="custom-control-input" tabindex="3" id="remember-me" value="yes">
            ...
            <div class="text-center mt-5 text-small">
              Copyright &copy; KPu Pak Kaji. Template By 💙 by Stisla
            </div>
          </div>
        </div>
