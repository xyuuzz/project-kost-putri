  ...
  <div id="app">
    <section class="section">
      <div class="container mt-5">
        <div class="row">
            <div class="login-brand m-auto container-fluid">
                <h5>Silahkan Masukan Username dan Password yang Diberikan</h5>
                <br>
            </div>
            <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="card card-primary">
              <div class="card-header"><h4>Form Login Website KPPK</h4></div>
              @error('failed_login')
                <span class="text-center alert-inner--text text-danger"><strong>{{ $message }}</strong></span>
              @enderror
