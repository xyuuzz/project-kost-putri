...
class HomeSavingController extends Controller
{
    ...
    public function index() 
    {
        ...
        $tables_data = $this->table->where("user_id", "=", Auth::id());
        ...
        return view("view.tabungan.home", compact("T_pemasukan", "T_pengeluaran", "arr_all_weeks", "presentase_selisih"));
    }
}
